...
var getFormFields = __webpack_require__(30);

var onCheckPrice = function onCheckPrice() {
  authApi.checkPrice().then(ui.checkPriceSuccess).catch(ui.checkPriceError);
};

// Add stock to user object in database and initiates stock card display as well
// as stock price check function
var onAddStock = function onAddStock(event) {
  ...
  if (data.stock.symbol === '') {
    ...
    authApi.addStock(data).then(ui.addStockSuccess).catch(ui.addStockError).then(onGetStocks);
  }
};

var onUpdateStock = function onUpdateStock(event) {
  event.preventDefault();
  var updateData = getFormFields(event.target);
  updateData.stock['id'] = $(event.target).data('id');
  authApi.updateStock(updateData).then(ui.updateStockSuccess).catch(ui.updateStockError).then(onGetStocks);
};

var onDeleteStock = function onDeleteStock(event) {
  event.preventDefault();
  var data = $(this).data('id');
  authApi.deleteStock(data).then(ui.deleteStockSuccess).catch(ui.deleteStockError).then(onGetStocks);
};

// Contacts server to collect user stock information and inititates stock price API call
var onGetStocks = function onGetStocks(event) {
  authApi.getStocks().then(ui.getStocksSuccess).catch(ui.getStocksError).then(onCheckPrice);
};
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(ui.signInSuccess).catch(ui.signInError).then(onGetStocks);
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.changePassword(data).then(ui.changePasswordSuccess).catch(ui.changePasswordError);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  authApi.signOut().then(ui.signOutSuccess).catch(ui.signOutFail);
};
...
var checkPrice = function checkPrice() {
  ...
  var stockData = [];
  for (var i = 0; i < store.userStocks.length; i++) {
  ...
  var symbolSplice = stockData.join(',');
  return $.ajax({
    method: 'GET',
...
var addStock = function addStock(data) {
  return $.ajax({
    method: 'POST',
...
var updateStock = function updateStock(data) {
  return $.ajax({
    method: 'PATCH',
...
var deleteStock = function deleteStock(data) {
  return $.ajax({
    method: 'DELETE',
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://intense-ocean-50048.herokuapp.com/',
...
var store = __webpack_require__(3);
var showStockList = __webpack_require__(12);
...
var priceDisplay = function priceDisplay() {
  for (var i = 0; i < store.stockPrices['Stock Quotes'].length; i++) {
    // Variable to store current stock symbol
    var stockSymbol = store.stockPrices['Stock Quotes'][i]['1. symbol'];
    // Gathering and rounding price of current stock
    var currentPrice = Math.round(100 * store.stockPrices['Stock Quotes'][i]['2. price']) / 100;
    // Calculating total value based off of price and number of shares store in a data-id
    var calculatedValue = Math.round(100 * store.stockPrices['Stock Quotes'][i]['2. price'] * $('.value-input-' + store.stockPrices['Stock Quotes'][i]['1. symbol']).data('id')) / 100;
...
var checkPriceSuccess = function checkPriceSuccess(checkPriceResponse) {
...
var getStocksSuccess = function getStocksSuccess(getStocksResponse) {
  store.userStocks = getStocksResponse.stocks;
  var showStocksHtml = showStockList({ stocks: getStocksResponse.stocks });
...
var addStockSuccess = function addStockSuccess() {
...
module.exports = {
  ...
  getStocksSuccess: getStocksSuccess,
  checkPriceSuccess: checkPriceSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return " <div class=\"card\" data-id=\""
    ...
    + "\">\n     <div class=\"card-body col-sm-2 col-med-2\">\n  <p class=\"card-text\">  Symbol: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.symbol : stack1), depth0))
    + "\n<br>\n    Shares: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.shares : stack1), depth0))
    + "</p>\n    <p class=\"price-input-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.symbol : stack1), depth0))
    + "\">Current price: Loading, please wait...</p>\n    <div class=\"value-input-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.symbol : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.shares : stack1), depth0))
    + "\">Value of shares: Loading, please wait...</div>\n    <form class=\"stock-update-form update-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <input class=\"inputReset\" name=\"stock[shares]\" placeholder=\"New Share Amount\" type=\"number\">\n      <button type=\"submit\">Update Share Amount</button>\n    </form>\n    <button class=\"update-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Change Share Amount</button>\n    <button class=\"delete-button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete Stock</button>\n  </div>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.stocks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
var addNestedValue = __webpack_require__(31);
